...
//
// 🚨 745가 아니라 775인 이유 — 맨 위 여백을 0까지 줄인 뒤에도 셰브론이 탭바 경계에 살짝
// 걸려 절반쯤 잘려 보였다(docs/아이폰 16-3.jpg). 요소를 더 위로 올릴 여백이 이제 없어서,
// 남은 방법은 전체를 아주 조금 더 축소해 여유를 만드는 것뿐이다. 30만큼 올려서(약 4%
// 축소) 셰브론이 완전히 들어올 여유를 확보했다 — 버튼 등이 눈에 띄지 않을 정도로만 살짝
// 작아진다.
const SCALE_FIT_HEIGHT = 775;
