...
//
// 🚨 top 값은 Figma 원본보다 일괄 55pt 작다 — index.tsx의 다른 요소들과 같은 이유(아이폰 16
// 실제 세로 여유 확보를 위해 캔버스 상단 여백을 55pt 줄이면서 전부 같이 위로 당김,
...
export const LEVEL_CHARACTER_HOME_BOX: Record<number, { left: number; top: number; width: number; height: number }> = {
  1: { left: 32, top: 176, width: 329, height: 220 },
  2: { left: 89, top: 130, width: 205, height: 292 },
  3: { left: -8, top: 89, width: 348, height: 348 },
  4: { left: -14, top: 99, width: 367, height: 296 },
  5: { left: 30, top: 134, width: 293, height: 270 },
};
